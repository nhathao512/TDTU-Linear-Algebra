...
Original file is located at
    https://colab.research.google.com/drive/1cleKpaBFBa6q8uODaP0sp2C2BlbrkMn7
"""
...
# import numpy as np
# A = np.array([[1, 2, 1],[2, -1, 1],[2, 1, 0]])    #3x3
...
print(D)
print()
A1 = np.matmul(np.linalg.inv(I - A), D.T)
print(A1)
...
m = 10
n = 10
A12 = np.random.randint(1, 100, (m ,n))
print("A12", A12.shape, "= \n", A12)
for i in range(A12.shape[0]):
  for j in range(A12.shape[1]):
    print("A[", i + 1, ",", j + 1, "] = ", A12[i,j])